...
# 使用方法
# 打包lynfoo正式环境镜像包 ./build.sh main build:lynfoo:prod mullet_manager
# 打包mullet正式环境镜像包 ./build.sh main build:mullet:prod mullet_manager
# 打包mullet测试环境镜像包 ./build.sh dev build:mullet:test mullet_manager
