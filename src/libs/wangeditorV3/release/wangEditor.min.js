!(function (e, t) {
  ...
  function h(e) {
    ...
    ;(this.editor = e),
      ...
      (this.droplist = new d(this, {
        ...
        type: 'list',
        list: [
          { $elem: o('<span style="font-size: x-small;">x-small</span>'), value: '1' },
          { $elem: o('<span style="font-size: small;">small</span>'), value: '2' },
          { $elem: o('<span>normal</span>'), value: '3' },
          { $elem: o('<span style="font-size: large;">large</span>'), value: '4' },
          { $elem: o('<span style="font-size: x-large;">x-large</span>'), value: '5' },
  ...
  function B(e) {
    ...
    ;(this.editor = e),
      ...
      (this.droplist = new d(this, {
        ...
        type: 'list',
        list: [
          { $elem: o('<span><i class="w-e-icon-list-numbered"></i> 有序列表</span>'), value: 'insertOrderedList' },
  ...
  function y(e) {
    ...
    ;(this.editor = e),
      ...
      (this.droplist = new d(this, {
        ...
        type: 'list',
        list: [
          { $elem: o('<span><i class="w-e-icon-paragraph-left"></i> 靠左</span>'), value: 'justifyLeft' },
          { $elem: o('<span><i class="w-e-icon-paragraph-center"></i> 居中</span>'), value: 'justifyCenter' },
  ...
  var z = {
      ...
      emotions: [
        ...
        { title: 'emoji', type: 'emoji', content: '😀 😃 😄 😁 😆 😅 😂 😊 😇 🙂 🙃 😉 😓 😪 😴 🙄 🤔 😬 🤐'.split(/\s/) }
      ],
      zIndex: 1e4,
      debug: !1,
  ...
  ;(f.prototype = {
    ...
    (m.prototype = {
      ...
      tryChangeActive: function (e) {
        ...
        i &&
          ('A' === i.getNodeName() ? ((this._active = !0), n.addClass('w-e-active')) : ((this._active = !1), n.removeClass('w-e-active')))
      }
    }),
    (g.prototype = {
      constructor: g,
        ...
        t.on('keydown', function (e) {
          ...
          t.on('keyup', function (n) {
            if (8 === n.keyCode) {
              ...
              ;(A && '<br>' !== A) ||
                ((i = o('<p><br/></p>')), t.html(''), t.append(i), e.selection.createRangeByElem(i, !1, !0), e.selection.restoreSelection())
            }
          })
      },
            ...
            if (
              ...
              (C.onreadystatechange = function () {
                ...
                if (4 === C.readyState) {
                  ...
                  if (((e = C.responseText), 'object' !== (void 0 === e ? 'undefined' : X(e))))
                    try {
                      e = JSON.parse(e)
                    } catch (i) {
                      return (
    ...
    _initDom: function () {
      ...
      null == i
        ? ((a = o('<div></div>')),
          ...
          s.css('border', '1px solid #ccc').css('border-top', 'none').css('height', '300px'))
