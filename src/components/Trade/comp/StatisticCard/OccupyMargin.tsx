...
function OccupyMargin() {
  ...
  return (
    <span className="text-base font-pf-bold  dark:text-primary" key={count}>
      {Number(occupyMargin) ? formatNum(occupyMargin, { precision: currencyDecimal }) : '0.00'}
    </span>
  )
}

export default observer(OccupyMargin)
