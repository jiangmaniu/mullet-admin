    ...
    return (
      <div style={{ ...style }} className="relative h-full px-[37px] max-xl:rounded-t-[16px] xl:py-[26px]">
        <div className="absolute left-8 flex w-[92%] justify-between">
          <div
            style={{ backgroundImage: `url(/platform/img/kline-water-logo.png)` }}
            className="relative top-0 h-[92px] w-[328px] bg-cover bg-no-repeat opacity-50"
          />
        ...
        <div className="mt-3 overflow-x-hidden max-xl:max-h-[60vh] overflow-y-auto max-h-[450px] max-xl:pb-8">
          <SwitchPcOrWapLayout
            pcComponent={
