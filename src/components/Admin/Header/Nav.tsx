...
function Nav({ position }: IProps) {
  ...
  return (
    <>
      {/* 占位 */}
      {!isForbid && <div className="h-[100px]"></div>}
      <nav
        className="z-[99] left-0 fixed bg-white mx-auto px-4 flex flex-col h-[100px] w-full"
      ...
      >
        <div className="flex items-center justify-between h-[64px]">
          ...
          <div className="flex justify-end items-center max-w-[600px]">
            ...
            <div className="mx-6 flex items-center">
              ...
              <span className="text-sm texg-gray font-semibold pl-1">{global.timeZone || 'GMT+8'}</span>
            </div>
            {/* <Message /> */}
        ...
        <div className="flex absolute top-[60px] w-full">
          {sidebarDom}
          <HeaderTabsView />
        </div>
      </nav>
