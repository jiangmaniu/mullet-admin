declare namespace AccountGroup {
  ...
  type UpdateAccountGroupConfig = {
     ...
     * 库存费配置（JSON）
     */
    holdingCostConf?: Symbol.HoldingCostConf
    /**
     * 品种配置主键
     */
    id?: number
     ...
     * 报价配置（JSON）
     */
    quotationConf?: Symbol.quotationConf
    /**
     * 交易-最高报价延迟
     */
