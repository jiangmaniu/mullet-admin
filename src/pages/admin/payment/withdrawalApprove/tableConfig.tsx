...
export const getColumns = (): ProColumns<PaymentWithdraw.WithdrawalOrderApprovalListItem>[] => {
  return [
    {
    ...
    // @TODO 暂时没字段
    {
      title: <FormattedMessage id="mt.chujintongdao" />,
    ...
    {
      title: <FormattedMessage id="mt.shoukuanren" />,
      dataIndex: 'userName',
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      fieldProps: {
    ...
    {
      title: <FormattedMessage id="mt.shoukuanyinhang" />,
      dataIndex: 'bankName',
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      fieldProps: {
    ...
    {
      title: <FormattedMessage id="mt.shoukuanzhanghu" />,
      dataIndex: 'bankCard',
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      fieldProps: {
    ...
    },
    {
      ...
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      valueEnum: getEnum().Enum.PaymentWithdrawalApprovalStatus,
      fieldProps: {
        placeholder: ''
      },
      formItemProps: {
    ...
    {
      title: <FormattedMessage id="mt.shenpiren" />,
      dataIndex: 'approver',
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      fieldProps: {
    ...
    {
      title: <FormattedMessage id="mt.shenpishijian" />,
