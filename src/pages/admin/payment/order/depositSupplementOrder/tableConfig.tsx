...
export const getColumns = (): ProColumns<PaymentDepositFillOrder.DepositFillOrderListItem>[] => {
  return [
    {
      title: <FormattedMessage id="mt.budandingdanhao" />,
      dataIndex: 'fillOrderNo',
    ...
    {
      title: <FormattedMessage id="mt.kehudingdanhao" />,
      dataIndex: 'userOrderNo',
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      copyable: false,
      fieldProps: {
    ...
    {
      title: <FormattedMessage id="mt.yuandingdanjine" />,
    ...
    {
      title: <FormattedMessage id="mt.budanhoujine" />,
      dataIndex: 'baseActualAmount',
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      fieldProps: {
        placeholder: ''
      ...
      width: 150,
      renderText(text, record, index, action) {
        return formatNum(record?.baseActualAmount, { precision: 2, noDataFormat: '0', unit: 'USD' })
      }
    },
    {
      title: <FormattedMessage id="mt.shijizhuanru" />,
      ...
      width: 150,
      renderText(text, record, index, action) {
        return formatNum(record?.actualAmount, { precision: 2, noDataFormat: '0', unit: record.symbol })
      }
    },
    {
      title: <FormattedMessage id="mt.budanzhuangtai" />,
      dataIndex: 'status',
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      fieldProps: {
      ...
      valueEnum: getEnum().Enum.PaymentDepositSupplementOrderStatus,
      width: 150
    },
    {
      title: <FormattedMessage id="mt.budanbeizhu" />,
      dataIndex: 'remark',
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      fieldProps: {
    ...
    },
    {
      ...
      fieldProps: {
        className: '!w-[150px]',
        placeholder: useIntl().formatMessage({ id: 'mt.kehudingdanhao' })
      },
      colSize: 0.9
    },
    {
