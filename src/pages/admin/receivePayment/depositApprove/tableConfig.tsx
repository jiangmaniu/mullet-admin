...
export const getColumns = (): ProColumns<DepositApprove.DepositApproveListItem>[] => {
  const intl = useIntl()
  ...
  return [
    ...
    {
      title: <FormattedMessage id="mt.zhifupingzheng" />,
      dataIndex: 'certificateStatus',
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      valueEnum: getEnum().Enum.PaymentVoucherStatus,
      fieldProps: {
        placeholder: ''
      },
      formItemProps: {
    ...
    },
    {
      ...
      fieldProps: {
        className: '!w-[180px]',
        placeholder: useIntl().formatMessage({ id: 'mt.kehuzhanghao' })
      },
      colSize: 0.9
    },
    {
    ...
    },
    {
      ...
      fieldProps: {
        className: '!w-[170px]',
        placeholder: useIntl().formatMessage({ id: 'mt.zhifupingzhengzhuangtai' })
      },
      valueEnum: getEnum().Enum.PaymentVoucherStatus,
      colSize: 0.9
    }
