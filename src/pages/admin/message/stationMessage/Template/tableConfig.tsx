...
import { updateSwitch } from '@/services/api/message/messageTemplate'
import { message } from '@/utils/message'

export const getColumns = (): ProColumns<MessageTemplate.MessageTemplateListItem>[] => {
  const [current, setCurrent] = useState({} as MessageTemplate.MessageTemplateListItem)
