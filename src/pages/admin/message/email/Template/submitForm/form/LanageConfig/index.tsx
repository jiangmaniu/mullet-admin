...
type IProps = {
  ...
  initialValues?: EmailTemplate.EmailTemplateListItem
}
...
export default forwardRef(({ style, onFieldsChange, onValuesChange, initialValues }: IProps, ref) => {
  ...
  useEffect(() => {
    if (initialValues?.id) {
      form.setFieldsValue({
        ...initialValues,
        templateLanguageAddDTOList: initialValues?.templateLanguageVOList || []
      })
    }
  }, [initialValues])
  ...
  return (
    ...
    >
      <div className="flex items-start flex-col w-full">
        <AddLangeFormItem name="templateLanguageAddDTOList" form={form} />
      </div>
    </Form>
  )
})
