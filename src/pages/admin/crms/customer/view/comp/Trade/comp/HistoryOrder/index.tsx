...
import { getClientAllOrder } from '@/services/api/crmManage/client'
...
export default function HistoryOrder({
  ...
  return (
    <StandardTable
      ...
      // ghost
      params={{ clientId: id, orderStatus: 'FINISH' as API.OrderStatus }}
      action={{
        query: (params) => getClientAllOrder(params)
      }}
    />
  )
}
