...
import { getClientPositions } from '@/services/api/crmManage/client'
...
export default function Position({
  ...
  const queryHanlder = async (params: any) => {
    ...
    const res = await getClientPositions(params)
