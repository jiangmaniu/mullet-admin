...
import { refuseOrPass } from '@/services/api/agent/withdrawalRecord'
...
function ModalForm({ reload }: IProps, ref: any) {
  ...
  return (
    <>
      <Modal
        title={<FormattedMessage id="mt.agent.fanyongshenhe" />}
        onFinish={async (values: any) => {
          console.log('values', values)

          const res = await refuseOrPass({ status: 'REFUSE', id: modalInfo.id, ...values })
