...
export const getColumns = (): ProColumns<Log.APIListItem>[] => {
  return [
    {
    ...
    // },
    {
      title: <FormattedMessage id="mt.rizhimokuai" />,
      dataIndex: 'client',
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      fieldProps: {
    ...
    {
      title: <FormattedMessage id="mt.caozuogongneng" />,
      dataIndex: 'title',
      hideInSearch: true, // 在 table的查询表单 中隐藏
      ellipsis: false,
      fieldProps: {
    ...
    // 表单搜索项
    {
      ...
      valueEnum: {
        // 模糊匹配client查询全部
        client: {
          text: <FormattedMessage id="common.all" />
        },
        ...getEnum().Enum.LogModuleType
      },
      fieldProps: {
        className: '!w-[180px]',
        placeholder: useIntl().formatMessage({ id: 'mt.rizhimokuai' })
      },
      colSize: 0.9,
      initialValue: 'client'
    },
    {
      ...
      fieldProps: {
        className: '!w-[180px]',
        placeholder: useIntl().formatMessage({ id: 'mt.caozuogongneng' })
      },
      colSize: 0.9
    },
    {
