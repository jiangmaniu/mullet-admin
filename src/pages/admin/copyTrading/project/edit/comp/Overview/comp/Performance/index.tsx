 ...
 * 帶單表現
 */
export default ({ time, datas }: IProps) => {
  const delay = 0.15

  // // 平均每笔收益率
  // const averageProfitRate = datas?.averageProfitRate || 10
  // // 总收益率
  // const earningRateTotal = datas?.earningRateTotal || 10
  // // 跟单盈亏
  // const followerProfit = datas?.followerProfit || 10
  // // 带单盈亏
  // const leadProfit = datas?.leadProfit || 10
  // // 回撤率
  // const retracementRate = datas?.retracementRate || 10
  // // 胜率
  // const winRate = datas?.winRate || 10
