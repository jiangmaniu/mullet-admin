...
export const STORAGE_REMOVE_OPEN_MENU_LIST = storageRemove(KEY_OPEN_MENU_LIST)
...
export const STORAGE_REMOVE_ACTIVE_MENU_PATH = storageRemove(KEY_ACTIVE_MENU_PATH)

// 本地存储-菜单权限
export const STORAGE_GET_MENU = genStorageGet(KEY_MENU)
export const STORAGE_SET_MENE = genStorageSet(KEY_MENU)
export const STORAGE_REMOVE_MENU = storageRemove(KEY_MENU)

// 本地存储-按钮权限
export const STORAGE_GET_MENU_BUTTON = genStorageGet(KEY_MENU_BUTTON)
export const STORAGE_SET_MENU_BUTTON = genStorageSet(KEY_MENU_BUTTON)
export const STORAGE_REMOVE_MENU_BUTTON = storageRemove(KEY_MENU_BUTTON)
...
// 本地存储-首页
export const STORAGE_GET_HOME_PAGE = genStorageGet(KEY_HOME_PAGE)
export const STORAGE_SET_HOME_PAGE = genStorageSet(KEY_HOME_PAGE)
export const STORAGE_REMOVE_HOME_PAGE = storageRemove(KEY_HOME_PAGE)
