  ...
  '/api/trade-agent/agentApi/users/rebateStandardsQuery': async (req: Request, res: Response) => {
      res.send({
        ...
        "data": {
            ...
            "tradeVolume": 11,
            "userCount": 22,
            "netDeposit": 33.00000000,
            "netValue": 44.00000000,
  ...
  '/api/trade-agent/agentApi/settings/settingsQuery': async (req: Request, res: Response) => {
      res.send({
        ...
        "data": {
            ...
            "maxAutoAuditAmount": 1.00000000,
            "minWithdrawAmount": 2.00000000,
            "levelConfigVoList": [
                {
                    "id": "1912173920981409794",
                    "levelName": "青铜",
                ...
                },
                {
                    ...
                    "tradeVolume": 22,
                    "userCount": 33,
                    "netDeposit": 44.00000000,
                    "netValue": 55.00000000,
                ...
                },
                {
                    ...
                    "tradeVolume": 33,
                    "userCount": 44,
                    "netDeposit": 55.00000000,
                    "netValue": 66.00000000,
                ...
                },
                {
                    ...
                    "tradeVolume": 44,
                    "userCount": 55,
                    "netDeposit": 66.00000000,
                    "netValue": 77.00000000,
