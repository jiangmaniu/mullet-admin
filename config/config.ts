...
let gitRevisionPlugin: GitRevisionPlugin | null = null
try {
  ...
  console.warn('git-revision-webpack-plugin: 无法获取 Git 信息，可能不在 Git 仓库中')
}
...
export default defineConfig({
  ...
  //     // 版本将上传到 https://poetry-m4.sentry.io/settings/projects/sux-manager/source-maps/
  //     release: {
  //       // sourcemap版本号
  ...
  // 开发环境使用 eval 模式，生产环境不使用 sourcemap
